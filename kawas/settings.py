...
# Media files (local fallback; uploads go directly to Cloudinary via CloudinaryField)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Storage backends — WhiteNoise for static; Django default for everything else.
# CloudinaryField handles media uploads directly; no custom default backend needed.
STORAGES = {
    "staticfiles": {
...
# Cloudinary credentials (Replit Secrets: CLOUDINARY_CLOUD_NAME, API_KEY, API_SECRET)
# CloudinaryField on each model uploads directly to Cloudinary using these credentials.
cloudinary.config(
